  ...
  <div class="w-72 mb-8">
    <div class="relative w-full min-w-[200px] h-10">
      <input
        v-model="inputValue"
        :type="type"
        class="peer w-full h-full bg-transparent text-gray-300 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 border focus:border-2 focus:border-t-transparent text-sm px-3 py-2.5 rounded-[7px] border-blue-gray-200 focus:border-gray-300"
        :class="{
